...
folder = "D:\\Carpe_outputs\\WW_analysis\\2017_WW_analysis\\comp_ww_wg_2017\\ndvi\\vehetr_bach1"
...
folder_2 = "D:\\Carpe_outputs\\WW_analysis\\2017_WW_analysis\\comp_ww_wg_2017\\ndvi\\nieger"
...
print(x_val)
plt.plot(x_val,y_val,"-r", Label = "Vehrter Bach I")
plt.plot(x_val,y_val2,"-b", Label = "Niegerts")
plt.plot(x_val,y_val3,"-r", Label = "Kämpe II")
plt.plot(x_val,y_val4,"-b", Label = "Gattberg I")
plt.plot(x_val,y_val5,"-r", Label = "Auf dem Stockum I")
plt.plot(x_val,y_val6,"-b", Label = "Auf dem Stockum II")
plt.plot(x_val,y_val7,"-b", Label = "Auf dem Brink")
plt.plot(x_val,y_val8,"-b", Label = "An der Panzerstrasse")
