...
temp = 'C:\\Users\\attiah\\Downloads\\selected_temp\\data\Copy of data_TMK_MN004.csv.'
...
data = list(zip(daf.Zeitstempel, daf.Wert))
...
folder = "D:\\Carpe_outputs\\2019_Corn-analysis\\am_tech2\\ndvi"
...
folder_2 = "D:\\Carpe_outputs\\2019_Corn-analysis\\auf_dem_1\\ndvi"
...
z = list(zip(file_name,lists,lists2,lists3,lists4,lists5,lists6,lists7,lists8,lists9))
print(lists)
print(file_name)
print(z)
